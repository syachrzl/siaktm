                ...
                <?php $no=1; foreach ($gallery as $key => $value) { ?>
                    <tr>
                        ...
                        <td class="text-center  ">
                            ...
                            <a href="<?= base_url('gallery/add_foto')?>" class="btn btn-outline btn-primary btn-xs"><i class="fa fa-plus"></i> Tambahkan Foto</a>
                        </td>
                        <td>
                            <a href="<?= base_url('gallery/edit/' . $value->id_gallery)?>" class="btn btn-xs btn-success" ><i class="fa fa-pencil"></i></a>
                            <a href="<?= base_url('gallery/delete/' . $value->id_gallery)?>" class="btn btn-xs btn-danger"  onclick="return confirm('Apakah data ini akan dihapus?')" ><i class="fa fa-trash"></i></a>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
