 ...
 <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="<?= base_url('siswa')?>"><i class="fa fa-graduation-cap fa-fw"></i> Siswa</a>
                            </li>
                            <li>
                                <a href="<?= base_url('pengumuman')?>"><i class="fa fa-edit fa-fw"></i>Pengumuman</a>
                            </li>
                            <li>
                                <a href="<?= base_url('berita')?>"><i class="fa fa-newspaper-o fa-fw"></i> Berita</a>
                            </li>
                            <li>
                                <a href="<?= base_url('gallery')?>"><i class="fa fa-folder fa-fw"></i> Gallery</a>
                            </li>
                    </div>
                    <!-- /.sidebar-collapse -->
                </div>
