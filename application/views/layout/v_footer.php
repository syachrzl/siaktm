...
<footer class="footer">
		<div class="footer_background" style="background-image:url(<?php base_url()?>template/frontend/images/footer_background.png)"></div>
		<div class="container">
							...
							<div class="col-lg-3 footer_col clearfix">
								...
								<div class="footer_section footer_mobile">
									...
									<div class="footer_mobile_content">
										<div class="footer_image"><a href="#"><img src="<?php echo base_url('template/frontend/images/mobile_1.png')?>" alt=""></a></div>
										<div class="footer_image"><a href="#"><img src="<?php echo base_url('template/frontend/images/mobile_2.png')?>" alt=""></a></div>
									</div>
								</div>
...
<script src="<?php echo base_url('template/frontend/styles/bootstrap4/popper.js') ?>"></script>
<script src="<?php echo base_url('template/frontend/styles/bootstrap4/bootstrap.min.js') ?>"></script>
